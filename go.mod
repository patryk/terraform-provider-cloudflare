...
require (
	...
	github.com/cloudflare/cloudflare-go v0.0.0-20190419211755-4e12583b2ac7
	...
	github.com/hashicorp/hcl2 v0.0.0-20190421202149-c27cd9b2e8db // indirect
	...
	google.golang.org/genproto v0.0.0-20190404175554-64821d5d2107 // indirect
)
